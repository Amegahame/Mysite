[1mdiff --git a/meu_projeto/manage.py b/meu_projeto/manage.py[m
[1mnew file mode 100644[m
[1mindex 0000000..2d168e7[m
[1m--- /dev/null[m
[1m+++ b/meu_projeto/manage.py[m
[36m@@ -0,0 +1,22 @@[m
...
[32m+[m[32m    os.environ.setdefault('DJANGO_SETTINGS_MODULE', 'meu_projeto.settings')[m
[32m+[m[32m    try:[m
...
[32m+[m[32m    main()[m
[1mdiff --git a/meu_projeto/meu_projeto/__init__.py b/meu_projeto/meu_projeto/__init__.py[m
[1mnew file mode 100644[m
[1mindex 0000000..e69de29[m
[1mdiff --git a/meu_projeto/meu_projeto/asgi.py b/meu_projeto/meu_projeto/asgi.py[m
[1mnew file mode 100644[m
[1mindex 0000000..deb2df4[m
[1m--- /dev/null[m
[1m+++ b/meu_projeto/meu_projeto/asgi.py[m
[36m@@ -0,0 +1,16 @@[m
[32m+[m[32m"""[m
[32m+[m[32mASGI config for meu_projeto project.[m
[32m+[m
...
[32m+[m
[32m+[m[32mos.environ.setdefault('DJANGO_SETTINGS_MODULE', 'meu_projeto.settings')[m
[32m+[m
[32m+[m[32mapplication = get_asgi_application()[m
[1mdiff --git a/meu_projeto/meu_projeto/settings.py b/meu_projeto/meu_projeto/settings.py[m
[1mnew file mode 100644[m
[1mindex 0000000..f506a79[m
[1m--- /dev/null[m
[1m+++ b/meu_projeto/meu_projeto/settings.py[m
[36m@@ -0,0 +1,123 @@[m
[32m+[m[32m"""[m
[32m+[m[32mDjango settings for meu_projeto project.[m
[32m+[m
...
[32m+[m[32mSECRET_KEY = 'django-insecure-nx*-bk@(1l561z)nzl304c25d==qm+1sdr6)h()^sp%@5+ke7@'[m
[32m+[m
...
[32m+[m[32m][m
[32m+[m
[32m+[m[32mROOT_URLCONF = 'meu_projeto.urls'[m
[32m+[m
...
[32m+[m[32m][m
[32m+[m
[32m+[m[32mWSGI_APPLICATION = 'meu_projeto.wsgi.application'[m
[32m+[m
[32m+[m
...
[1mdiff --git a/meu_projeto/meu_projeto/urls.py b/meu_projeto/meu_projeto/urls.py[m
[1mnew file mode 100644[m
[1mindex 0000000..f6403ac[m
[1m--- /dev/null[m
[1m+++ b/meu_projeto/meu_projeto/urls.py[m
[36m@@ -0,0 +1,22 @@[m
[32m+[m[32m"""[m
[32m+[m[32mURL configuration for meu_projeto project.[m
[32m+[m
